...
### Method [`getStaticFields()`](http://www.open-systems-pharmacology.org/rSharp/reference/getStaticFields.md)
...
### Method [`getStaticProperties()`](http://www.open-systems-pharmacology.org/rSharp/reference/getStaticProperties.md)
...
### Method [`getStaticMethods()`](http://www.open-systems-pharmacology.org/rSharp/reference/getStaticMethods.md)
