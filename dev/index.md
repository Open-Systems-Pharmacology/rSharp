...
The [rSharp](https://github.com/Open-Systems-Pharmacology/rsharp/) R
package provides access to `.NET` libraries from R. It allows to create
...
As [rSharp](https://github.com/Open-Systems-Pharmacology/rsharp/) is
provided with precompiled binary files, it is currently a
...
detailed in
[`vignette('user-guide')`](http://www.open-systems-pharmacology.org/rSharp/dev/articles/user-guide.md).
Some useful tips around using the package are available in the
[`vignette('knowledge-base')`](http://www.open-systems-pharmacology.org/rSharp/dev/articles/knowledge-base.md).
...
License](http://www.open-systems-pharmacology.org/rSharp/dev/LICENSE).
