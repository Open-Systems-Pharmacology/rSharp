...
#' }
#'
#' rSharp is a package for low-level access from R to a Common Language Runtime (CLR). The supported CLR implementations are Microsoft '.NET'
#' framework on Windows and Mono on several platforms, currently Windows and at least Debian Linux. rSharp has been used in scientific modelling work since
