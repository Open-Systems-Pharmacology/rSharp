...
namespace RDotNet
{
   ...
   public class RuntimeDiagnostics
   {
      ...
      public static IDictionary<string, Action<REngine, int, Stopwatch>> GetMatrixCreationFunctions()
      {
         ...
         m["numeric"] = CreateNumericMatrix;
         m["integer"] = CreateIntegerMatrix;
         m["logical"] = CreateLogicalMatrix;
         m["character"] = CreateCharacterMatrix;
         return m;
      }
      ...
      {
         var m = new Dictionary<string, Action<REngine, int, Stopwatch>>();
         m["numeric"] = CreateNumericVector;
         m["integer"] = CreateIntegerVector;
         m["logical"] = CreateLogicalVector;
         m["character"] = CreateCharacterVector;
         return m;
      }
      ...
      {
         var m = new Dictionary<string, Action<REngine, int, Stopwatch>>();
         m["numeric"] = RtoDotNetNumericMatrix;
         m["integer"] = RtoDotNetIntegerMatrix;
         m["logical"] = RtoDotNetLogicalMatrix;
         m["character"] = RtoDotNetCharacterMatrix;
         return m;
      }
      ...
      {
         var m = new Dictionary<string, Action<REngine, int, Stopwatch>>();
         m["numeric"] = RtoDotNetNumericVector;
         m["integer"] = RtoDotNetIntegerVector;
         m["logical"] = RtoDotNetLogicalVector;
         m["character"] = RtoDotNetCharacterVector;
         return m;
      }
