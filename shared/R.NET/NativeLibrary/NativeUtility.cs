...
namespace RDotNet.NativeLibrary
{
   ...
   public class NativeUtility
   {
      ...
      ///    so this method cannot check the OS correctly if the PATH environment variable is changed (will returns
      ///    <see cref="PlatformID.Unix" />).
      /// </remarks>
      ...
      /// </summary>
      public static string SetEnvironmentVariablesLog
      {
         get { return logSetEnvVar.ToString(); }
      }
      ...
      /// <summary>
      ///    Try to locate the directory path to use for the R_HOME environment variable. This is used by R.NET by default; users
      ///    may want to use it to diagnose problematic behaviors.
      /// </summary>
      /// <param name="rPath">
      ///    Optional path to the directory containing the R shared library. This is ignored unless on a Unix
      ///    platform (i.e. ignored on Windows and MacOS)
      /// </param>
      ...
      /// <summary>
      ///    Attempt to find a suitable path to the R shared library. This is used by R.NET by default; users may want to use it
      ///    to diagnose problematic behaviors.
      /// </summary>
