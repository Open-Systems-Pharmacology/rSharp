...
namespace RDotNet
{
   ...
   public abstract class Function : SymbolicExpression
   {
      ...
      /// <summary>
      ///    A convenience method to executes the function. Match the function arguments by order, after evaluating each to an R
      ///    expression.
      /// </summary>
      /// <param name="args">
      ///    string representation of the arguments; each is evaluated to symbolic expression before being passed
      ///    as argument to this object (i.e. this Function)
      /// </param>
      /// <returns>The result of the function evaluation</returns>
      /// <example>
      ///    <code>
      ...
      /// </summary>
      /// <param name="args">
      ///    one or more tuples, conceptually a pairlist of arguments.
      ///    The argument names must be unique; null or empty string indicates unnamed argument.
      /// </param>
      /// <returns>The result of the function evaluation</returns>
