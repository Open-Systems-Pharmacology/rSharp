...
namespace RDotNet
{
   ...
   public static class REngineExtension
   {
      ...
      /// <param name="columns">
      ///    The columns with the values for the data frame. These must be array of supported types (double,
      ///    string, bool, integer, byte)
      /// </param>
      ...
      /// <param name="stringsAsFactors">
      ///    Should columns of strings be considered as factors (categories). See data.frame R
      ///    documentation
      /// </param>
      /// <returns></returns>
