...
namespace RDotNet
{
   ...
   public class DataFrameRow : DynamicObject
   {
      ...
      /// </summary>
      /// <param name="binder">
      ///    Dynamic get member operation at the call site; Binder whose name should be one of the data frame
      ///    column name
      /// </param>
      ...
      /// </summary>
      /// <param name="binder">
      ///    Dynamic set member operation at the call site; Binder whose name should be one of the data frame
      ///    column name
      /// </param>
