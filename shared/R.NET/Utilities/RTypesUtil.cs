...
namespace RDotNet.Utilities
{
   ...
   /// <summary>
   ///    An internal helper class to convert types of arrays, primarily for data operations necessary for .NET types to/from
   ///    R concepts.
   /// </summary>
   public static class RTypesUtil
   {
      /// <summary>
      ///    Serialize an array of complex numbers to
      ///    an array of doubles, alternating real and imaginary values
      /// </summary>
