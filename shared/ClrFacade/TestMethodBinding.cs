...
{
   public static string[] SomeStaticMethod(object obj)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(object obj)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(object obj)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(string x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(string x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(string x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(double x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(double x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(double x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(float x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(float x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(float x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }
   ...
   public string[] SomeInstanceMethod(int x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(int x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(bool x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }
   ...
   public static string[] SomeStaticMethod(DateTime x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(DateTime x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(DateTime x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(byte x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }
   ...
   public string[] SomeInstanceMethod(char x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(char x)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(object obj1, object obj2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(object obj1, object obj2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(object obj1, object obj2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(string x1, string x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(string x1, string x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(string x1, string x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(double x1, double x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(double x1, double x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(double x1, double x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(float x1, float x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(float x1, float x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(float x1, float x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(int x1, int x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(int x1, int x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(int x1, int x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(bool x1, bool x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(bool x1, bool x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(bool x1, bool x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(DateTime x1, DateTime x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }
   ...
   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(DateTime x1, DateTime x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(byte x1, byte x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(byte x1, byte x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(byte x1, byte x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(char x1, char x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(char x1, char x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(char x1, char x2)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }
   ...
   public static string[] SomeStaticMethod(double x, string y)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(double x, string y)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(double x, string y)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public static string[] SomeStaticMethod(double x, string y, string z)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(double x, string y, string z)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(double x, string y, string z)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }
   ...
   public static string[] SomeStaticMethod(string x, string[] y)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   public string[] SomeInstanceMethod(string x, string[] y)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }

   string[] ITestMethodBindings.SomeExplicitlyImplementedMethod(string x, string[] y)
   {
      return InternalReflectionHelper.GetMethodParameterTypes(MethodBase.GetCurrentMethod());
   }
