...
namespace RDotNet
{
   public class DataFrameRowMappingTest : RDotNetTestFixture
   {
      ...
      public void TestDataFrameSubsetting()
      {
         ...
         var sameRef = ReferenceEquals(species, species50);
   ...
   {
      [DataFrameColumn("Sepal.Length")] public double SepalLength { get; set; }

      [DataFrameColumn("Sepal.Width")] public double SepalWidth { get; set; }

      [DataFrameColumn("Petal.Length")] public double PetalLength { get; set; }

      [DataFrameColumn("Petal.Width")] public double PetalWidth { get; set; }

      [DataFrameColumn("Species")] public Iris Species { get; set; }
   }
}