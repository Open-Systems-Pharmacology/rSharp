...
namespace RDotNet
{
   ...
   {
      private readonly MockRegistryKey currentUser;
      private readonly MockRegistryKey localMachine;
   ...
   public class MockRegistryKey : IRegistryKey
   {
      ...
      private readonly List<MockRegistryKey> subKeys = new List<MockRegistryKey>();
