...
namespace DynamicInterop
{
   ...
   ///    memory blocks, and converting managed to unmanaged types
   /// </summary>
   class MarshalExtra
   {
      ...
      /// <summary>
      ///    Marshals data from an unmanaged block of memory to a newly allocated managed object of the type specified by a
      ///    generic type parameter.
      ///    Note it is almost superseded in .NET Framework 4.5.1 and later versions; consider your needs
      /// </summary>
      ...
      /// <param name="cleanup">
      ///    (Optional) If true, free the native memory block pointed to by ptr. This feature is handy in
