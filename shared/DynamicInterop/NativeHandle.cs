...
namespace DynamicInterop
{
   ...
   /// <remarks>
   ///    This is similar in intent to the BCL SafeHandle, but with release
   ...
   public abstract class NativeHandle : INativeHandle
   {
      ...
      /// <remarks>
      ///    If a native object was created prior to its use by .NET, its lifetime may need to extend its use
      ///    from .NET. In practice the scenario is unlikely
      /// </remarks>
      ...
      ///    Defers setting the handle to the derived class
      /// </summary>
      ...
      ///    Thrown when a pointer is a Zero pointer
      ///    .
      /// </exception>
      /// <param name="pointer">         The handle, value of the pointer to the native object</param>
      /// <param name="currentRefCount"> (Optional) Number of pre-existing references for the native object</param>
