...
namespace DynamicInterop
{
   ...
   public static class PlatformUtility
   {
      ...
      /// <summary>
      ///    Given a DLL short file name, find all the matching occurences in directories as stored in an environment variable
      ///    such as the PATH.
      /// </summary>
      ...
      ///    defaults according to platform to PATH or LD_LIBRARY_PATH if empty.
      /// </param>
      ...
      public static string CreateLibraryFileName(string libraryName)
      {
         ...
         return
            (Environment.OSVersion.Platform == PlatformID.Win32NT ? libraryName + ".dll" : "lib" + libraryName + ".so");
      }
   }
}