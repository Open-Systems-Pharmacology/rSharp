...
detailed in
[`vignette('user-guide')`](http://www.open-systems-pharmacology.org/rSharp/articles/user-guide.md).
Some useful tips around using the package are available in the
[`vignette('knowledge-base')`](http://www.open-systems-pharmacology.org/rSharp/articles/knowledge-base.md).
...
License](http://www.open-systems-pharmacology.org/rSharp/LICENSE).
