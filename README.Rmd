...
Start your preferred R environment and run the following R commands from within the ```rSharp``` folder to install the package using prebuilt binaries
...
Download and install R https://cran.r-project.org/bin/windows/base/old/4.3.1/

Open your preferred R environment and run the following R commands from within the ```rSharp``` folder
...
To optionally set up to build the binaries make sure ```Desktop development with C++``` workload is installed in Visual Studio.
